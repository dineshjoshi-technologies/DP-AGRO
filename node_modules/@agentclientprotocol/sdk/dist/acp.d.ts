...
export { AGENT_METHODS, CLIENT_METHODS, PROTOCOL_VERSION, } from "./schema/index.js";
export * from "./stream.js";
export { RequestError } from "./jsonrpc.js";
export type { AnyMessage, AnyNotification, AnyRequest, AnyResponse, ErrorResponse, MaybePromise, Result, } from "./jsonrpc.js";
import type { Stream } from "./stream.js";
import type { MaybePromise } from "./jsonrpc.js";
/**
...
export declare class AgentContext extends AcpContext {
     ...
     */
    request<Method extends ClientRequestMethod>(method: Method, params: ClientRequestParamsByMethod[Method]): Promise<ClientRequestResponsesByMethod[Method]>;
...
export declare class ClientContext extends AcpContext {
     ...
     * methods can specify their response and params types with generics.
     */
    request<Method extends AgentRequestMethod>(method: Method, params: AgentRequestParamsByMethod[Method]): Promise<AgentRequestResponsesByMethod[Method]>;
    request<Response = unknown, Params = unknown>(method: string, params?: Params): Promise<Response>;
    /**
...
export declare class ActiveSession {
     ...
     */
    prompt(prompt: string | schema.ContentBlock | Array<schema.ContentBlock>): Promise<schema.PromptResponse>;
    /**
 ...
 */
export type AgentRequestHandler<Params, Response> = (context: AgentHandlerContext<Params>) => MaybePromise<Response>;
/**
 * Notification handler registered on an `AgentApp`.
 */
export type AgentNotificationHandler<Params> = (context: AgentHandlerContext<Params>) => MaybePromise<void>;
/**
 * Request handler registered on a `ClientApp`.
 */
export type ClientRequestHandler<Params, Response> = (context: ClientHandlerContext<Params>) => MaybePromise<Response>;
/**
 * Notification handler registered on a `ClientApp`.
 */
export type ClientNotificationHandler<Params> = (context: ClientHandlerContext<Params>) => MaybePromise<void>;
/**
