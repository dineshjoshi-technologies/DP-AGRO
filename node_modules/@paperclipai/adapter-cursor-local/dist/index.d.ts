...
export declare const type = "cursor";
export declare const label = "Cursor CLI (local)";
export declare const SANDBOX_INSTALL_COMMAND = "curl https://cursor.com/install -fsS | bash";
export declare const DEFAULT_CURSOR_LOCAL_MODEL = "auto";
