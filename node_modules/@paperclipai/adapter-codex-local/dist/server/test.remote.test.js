...
vi.mock("./codex-home.js", async () => {
    const actual = await vi.importActual("./codex-home.js");
    return {
        ...actual,
...
describe("codex remote environment diagnostics", () => {
    ...
    it("stages managed CODEX_HOME in an isolated runtime dir and keeps the probe cwd on the original remote workspace", async () => {
        ...
        const runtimeCalls = prepareAdapterExecutionTargetRuntime.mock.calls;
        ...
        const probeCall = runAdapterExecutionTargetProcess.mock.calls[0];
...
//# sourceMappingURL=test.remote.test.js.map