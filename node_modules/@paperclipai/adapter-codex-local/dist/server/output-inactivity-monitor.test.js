...
import { CODEX_OUTPUT_INACTIVITY_MONITOR_SIGTERM_GRACE_MS, DEFAULT_CODEX_OUTPUT_INACTIVITY_TIMEOUT_MS, createCodexOutputInactivityMonitor, formatOutputInactivityMonitorErrorMessage, resolveCodexInactivityTimeout, } from "./output-inactivity-monitor.js";
class FakeClock {
    nowMs = 0;
    nextHandle = 1;
    timers = new Map();
...
describe("createCodexOutputInactivityMonitor (acceptance criteria 2: does not fire)", () => {
    ...
    it("multiple events in one chunk all reset the timer", () => {
        ...
        clock.advance(500);
        monitor.noteStdoutChunk('{"type":"thread.started","thread_id":"a"}\n{"type":"item.completed","item":{"type":"agent_message","text":"hi"}}\n');
...
describe("createCodexOutputInactivityMonitor (acceptance criteria 3: disabled)", () => {
    it("resolveCodexInactivityTimeout returns disabled for null and the adapter creates no monitor", () => {
        ...
        expect(() => createCodexOutputInactivityMonitor({
            timeoutMs: 0,
            onFire: () => { },
        })).toThrow(/timeoutMs > 0/);
    });
...
//# sourceMappingURL=output-inactivity-monitor.test.js.map