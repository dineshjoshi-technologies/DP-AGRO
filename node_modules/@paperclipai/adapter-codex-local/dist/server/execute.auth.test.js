...
describe("codex managed-home auth fail-fast", () => {
    ...
    it("fails fast when a managed CODEX_HOME has no auth.json and OPENAI_API_KEY is empty", async () => {
        ...
        const managedAgentHome = path.join(paperclipHome, "instances", "default", "companies", "company-1", "agents", "agent-1", "codex-home");
...
//# sourceMappingURL=execute.auth.test.js.map