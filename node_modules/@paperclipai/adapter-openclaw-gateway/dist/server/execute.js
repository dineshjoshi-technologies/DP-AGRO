import { asNumber, asString, buildPaperclipEnv, parseObject, readPaperclipIssueWorkModeFromContext, renderPaperclipWakePrompt, stringifyPaperclipWakePayload, } from "@paperclipai/adapter-utils/server-utils";
...
function buildPaperclipEnvForWake(ctx, wakePayload) {
    ...
    if (issueWorkMode)
        paperclipEnv.PAPERCLIP_ISSUE_WORK_MODE = issueWorkMode;
...
export async function execute(ctx) {
    ...
    while (true) {
        ...
        try {
            ...
            const isTransient = !pairingRequired &&
            ...
            if (isTransient && retryCount < MAX_RETRIES) {
                ...
                await ctx.onLog("stdout", `[openclaw-gateway] transient error, retry ${retryCount}/${MAX_RETRIES} after ${backoffMs}ms: ${message}\n`);
