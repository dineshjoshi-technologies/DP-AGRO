...
import { BUILTIN_ROUTINE_VARIABLE_NAMES, extractRoutineVariableNames, getBuiltinRoutineVariableValues, interpolateRoutineTemplate, isBuiltinRoutineVariable, isRoutineDateVariableName, isValidRoutineDateString, syncRoutineVariablesWithTemplate, } from "./routine-variables.js";
describe("routine variable helpers", () => {
    ...
    it("preserves existing metadata when syncing variables from a template", () => {
        expect(syncRoutineVariablesWithTemplate(["Triage {{repo}}", "Review {{repo}} and {{startDate}}"], [
    ...
    it("defaults newly synced capital-Date variables to date type", () => {
        expect(syncRoutineVariablesWithTemplate("Compare {{startDate}} to {{endDate}} with {{date}}", [])).toEqual([
    ...
    it("interpolates variables that appear with markdown-escaped underscores", () => {
        expect(interpolateRoutineTemplate("Open {{pr\\_url}}", { pr_url: "https://example.com" })).toBe("Open https://example.com");
    });
