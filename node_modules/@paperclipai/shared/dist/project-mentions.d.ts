...
export declare const PIPELINE_MENTION_SCHEME = "pipeline://";
...
export declare function buildPipelineMentionHref(pipelineId: string, stageKey?: string | null): string;
export declare function parsePipelineMentionHref(href: string): ParsedPipelineMention | null;
...
export declare function extractPipelineMentions(markdown: string): ParsedPipelineMention[];
