...
export declare const createBoardApiKeySchema: z.ZodObject<{
...
export declare const updateMemberPermissionsSchema: z.ZodObject<{
    grants: z.ZodArray<z.ZodObject<{
        permissionKey: z.ZodEnum<["agents:create", "skills:create", "environments:manage", "users:invite", "users:manage_permissions", "tasks:assign", "tasks:assign_scope", "tasks:manage_active_checkouts", "pipelines:write", "joins:approve"]>;
        scope: z.ZodNullable<z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>>;
    }, "strip", z.ZodTypeAny, {
        permissionKey: "agents:create" | "skills:create" | "environments:manage" | "users:invite" | "users:manage_permissions" | "tasks:assign" | "tasks:assign_scope" | "tasks:manage_active_checkouts" | "pipelines:write" | "joins:approve";
