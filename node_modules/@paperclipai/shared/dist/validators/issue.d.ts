...
export declare const issueExecutionPolicySchema: z.ZodObject<{
    ...
    reviewPreset: z.ZodOptional<z.ZodObject<{
        id: z.ZodLiteral<"low_trust_review">;
        version: z.ZodLiteral<1>;
        rawOutputDisposition: z.ZodLiteral<"quarantine">;
    }, "strict", z.ZodTypeAny, {
        id: "low_trust_review";
        version: 1;
    ...
    authorizationPolicy: z.ZodOptional<z.ZodObject<{
        trustPreset: z.ZodOptional<z.ZodEnum<["standard", "low_trust_review"]>>;
        reviewPreset: z.ZodOptional<z.ZodObject<{
            id: z.ZodLiteral<"low_trust_review">;
            version: z.ZodLiteral<1>;
            rawOutputDisposition: z.ZodLiteral<"quarantine">;
        ...
        trustBoundary: z.ZodOptional<z.ZodObject<{
            mode: z.ZodLiteral<"low_trust_review">;
            companyId: z.ZodOptional<z.ZodString>;
            projectIds: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
            rootIssueId: z.ZodOptional<z.ZodString>;
            issueIds: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
            allowedAgentIds: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
            allowedSecretBindingIds: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
            allowedToolClasses: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
            outputPromotionTarget: z.ZodOptional<z.ZodObject<{
            ...
            allowedSecretBindingIds?: string[] | undefined;
    ...
    authorizationPolicy?: z.objectOutputType<{
        trustPreset: z.ZodOptional<z.ZodEnum<["standard", "low_trust_review"]>>;
        reviewPreset: z.ZodOptional<z.ZodObject<{
            id: z.ZodLiteral<"low_trust_review">;
            version: z.ZodLiteral<1>;
    ...
    authorizationPolicy?: z.objectInputType<{
        trustPreset: z.ZodOptional<z.ZodEnum<["standard", "low_trust_review"]>>;
        reviewPreset: z.ZodOptional<z.ZodObject<{
            id: z.ZodLiteral<"low_trust_review">;
            version: z.ZodLiteral<1>;
...
export declare const issueRecoveryActionReadModelSchema: z.ZodObject<{
    ...
    kind: z.ZodEnum<["missing_disposition", "stranded_assigned_issue", "workspace_validation", "configuration_validation", "active_run_watchdog", "issue_graph_liveness"]>;
    ...
    kind: "missing_disposition" | "stranded_assigned_issue" | "workspace_validation" | "configuration_validation" | "active_run_watchdog" | "issue_graph_liveness";
    id: string;
...
export declare const createIssueInputSchema: z.ZodObject<{
    ...
    workMode: z.ZodDefault<z.ZodOptional<z.ZodEnum<["standard", "ask", "planning"]>>>;
    ...
    watchdogDiscovery: z.ZodNullable<z.ZodOptional<z.ZodObject<{
        kind: z.ZodEnum<["product_bug", "platform_bug"]>;
        evidenceMarkdown: z.ZodNullable<z.ZodOptional<z.ZodEffects<z.ZodString, string, string>>>;
    }, "strict", z.ZodTypeAny, {
        kind: "product_bug" | "platform_bug";
        evidenceMarkdown?: string | null | undefined;
    }, {
        kind: "product_bug" | "platform_bug";
        evidenceMarkdown?: string | null | undefined;
    }>>>;
    watchdog: z.ZodNullable<z.ZodOptional<z.ZodObject<{
        agentId: z.ZodString;
        instructions: z.ZodNullable<z.ZodOptional<z.ZodEffects<z.ZodString, string, string>>>;
    }, "strict", z.ZodTypeAny, {
        agentId: string;
    ...
    blockedByIssueIds?: string[] | undefined;
    inheritExecutionWorkspaceFromIssueId?: string | null | undefined;
    workMode?: "standard" | "ask" | "planning" | undefined;
...
export declare const upsertIssueWatchdogSchema: z.ZodObject<{
    agentId: z.ZodString;
    instructions: z.ZodNullable<z.ZodOptional<z.ZodEffects<z.ZodString, string, string>>>;
}, "strict", z.ZodTypeAny, {
    agentId: string;
...
export declare const createAcceptedPlanDecompositionSchema: z.ZodObject<{
    acceptedPlanRevisionId: z.ZodString;
    children: z.ZodArray<z.ZodEffects<z.ZodObject<Omit<{
        projectId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
        projectWorkspaceId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
        goalId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
        parentId: z.ZodNullable<z.ZodOptional<z.ZodString>>;
...
export declare const updateIssueSchema: z.ZodObject<{
    ...
    workMode: z.ZodOptional<z.ZodDefault<z.ZodOptional<z.ZodEnum<["standard", "ask", "planning"]>>>>;
    ...
    watchdogDiscovery: z.ZodOptional<z.ZodNullable<z.ZodOptional<z.ZodObject<{
        kind: z.ZodEnum<["product_bug", "platform_bug"]>;
        evidenceMarkdown: z.ZodNullable<z.ZodOptional<z.ZodEffects<z.ZodString, string, string>>>;
    }, "strict", z.ZodTypeAny, {
        kind: "product_bug" | "platform_bug";
...
export declare const issueThreadInteractionKindSchema: z.ZodEnum<["suggest_tasks", "ask_user_questions", "request_confirmation", "request_checkbox_confirmation"]>;
...
export declare const suggestedTaskDraftSchema: z.ZodEffects<z.ZodObject<{
    ...
    workMode: z.ZodOptional<z.ZodNullable<z.ZodEnum<["standard", "ask", "planning"]>>>;
    ...
    goalId?: string | null | undefined;
    parentId?: string | null | undefined;
    workMode?: "standard" | "ask" | "planning" | null | undefined;
    billingCode?: string | null | undefined;
...
export declare const askUserQuestionsAnswerSchema: z.ZodObject<{
    ...
    otherText: z.ZodOptional<z.ZodNullable<z.ZodPipeline<z.ZodEffects<z.ZodString, string, string>, z.ZodString>>>;
}, "strip", z.ZodTypeAny, {
    questionId: string;
    optionIds: string[];
...
export declare const requestCheckboxConfirmationOptionSchema: z.ZodObject<{
    id: z.ZodString;
    label: z.ZodString;
    description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
}, "strip", z.ZodTypeAny, {
...
export declare const requestCheckboxConfirmationPayloadSchema: z.ZodEffects<z.ZodObject<{
    version: z.ZodLiteral<1>;
    prompt: z.ZodString;
    detailsMarkdown: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    options: z.ZodArray<z.ZodObject<{
    ...
    defaultSelectedOptionIds: z.ZodDefault<z.ZodOptional<z.ZodArray<z.ZodString, "many">>>;
    minSelected: z.ZodDefault<z.ZodOptional<z.ZodNumber>>;
    maxSelected: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    acceptLabel: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    rejectLabel: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    rejectRequiresReason: z.ZodOptional<z.ZodBoolean>;
    rejectReasonLabel: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    ...
    detailsMarkdown?: string | null | undefined;
    supersedeOnUserComment?: boolean | undefined;
    maxSelected?: number | null | undefined;
}, {
    prompt: string;
    options: {
        id: string;
    ...
    detailsMarkdown?: string | null | undefined;
    supersedeOnUserComment?: boolean | undefined;
    defaultSelectedOptionIds?: string[] | undefined;
...
export declare const requestCheckboxConfirmationResultSchema: z.ZodEffects<z.ZodObject<{
    version: z.ZodLiteral<1>;
    outcome: z.ZodEnum<["accepted", "rejected", "superseded_by_comment", "stale_target"]>;
    reason: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    commentId: z.ZodOptional<z.ZodNullable<z.ZodString>>;
...
export declare const createIssueThreadInteractionSchema: z.ZodDiscriminatedUnion<"kind", [z.ZodObject<{
    ...
    kind: z.ZodLiteral<"request_checkbox_confirmation">;
    idempotencyKey: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    sourceCommentId: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    sourceRunId: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    title: z.ZodOptional<z.ZodNullable<z.ZodString>>;
