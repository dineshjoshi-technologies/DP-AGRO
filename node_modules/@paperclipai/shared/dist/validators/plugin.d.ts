...
export declare const pluginEnvironmentDriverDeclarationSchema: z.ZodObject<{
    ...
    displayName: z.ZodString;
    description: z.ZodOptional<z.ZodString>;
    supportsReusableLeases: z.ZodOptional<z.ZodBoolean>;
    ...
    supportsReusableLeases?: boolean | undefined;
}, {
    displayName: string;
    driverKey: string;
    configSchema: Record<string, unknown>;
...
export declare const pluginManagedRoutineDeclarationSchema: z.ZodObject<{
    ...
    variables: z.ZodOptional<z.ZodArray<z.ZodEffects<z.ZodObject<{
        ...
        type: z.ZodDefault<z.ZodOptional<z.ZodEnum<["text", "textarea", "number", "boolean", "select", "date"]>>>;
        ...
        type: "number" | "boolean" | "text" | "textarea" | "select" | "date";
        name: string;
        required: boolean;
        options: string[];
        ...
        name: string;
        type?: "number" | "boolean" | "text" | "textarea" | "select" | "date" | undefined;
...
export declare const pluginObjectReferenceRefreshPolicySchema: z.ZodEffects<z.ZodObject<{
    defaultTtlSeconds: z.ZodOptional<z.ZodNumber>;
    staleAfterSeconds: z.ZodOptional<z.ZodNumber>;
}, "strip", z.ZodTypeAny, {
...
export declare const pluginObjectReferenceProviderDeclarationSchema: z.ZodEffects<z.ZodObject<{
    providerKey: z.ZodString;
    displayName: z.ZodString;
    objectTypes: z.ZodArray<z.ZodString, "many">;
    urlPatterns: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
    refreshPolicy: z.ZodOptional<z.ZodEffects<z.ZodObject<{
        defaultTtlSeconds: z.ZodOptional<z.ZodNumber>;
        staleAfterSeconds: z.ZodOptional<z.ZodNumber>;
    }, "strip", z.ZodTypeAny, {
        defaultTtlSeconds?: number | undefined;
    ...
    webhookEndpointKeys: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
}, "strip", z.ZodTypeAny, {
    displayName: string;
    providerKey: string;
    objectTypes: string[];
    ...
    webhookEndpointKeys?: string[] | undefined;
}, {
    displayName: string;
    providerKey: string;
    objectTypes: string[];
...
export type PluginObjectReferenceProviderDeclarationInput = z.infer<typeof pluginObjectReferenceProviderDeclarationSchema>;
/**
...
export declare const pluginManifestV1Schema: z.ZodEffects<z.ZodObject<{
    ...
    capabilities: z.ZodArray<z.ZodEnum<["companies.read", "projects.read", "project.workspaces.read", "execution.workspaces.read", "issues.read", "issue.relations.read", "issue.subtree.read", "issue.comments.read", "issue.documents.read", "agents.read", "goals.read", "goals.create", "goals.update", "activity.read", "costs.read", "issues.orchestration.read", "access.members.read", "access.invites.read", "authorization.grants.read", "authorization.policies.read", "authorization.audit.read", "database.namespace.read", "issues.create", "issues.update", "issue.relations.write", "issues.checkout", "issues.wakeup", "issue.comments.create", "issue.interactions.create", "issue.documents.write", "projects.managed", "routines.managed", "skills.managed", "agents.pause", "agents.resume", "agents.invoke", "agents.managed", "access.members.write", "access.invites.write", "authorization.grants.write", "authorization.policies.write", "agent.sessions.create", "agent.sessions.list", "agent.sessions.send", "agent.sessions.close", "activity.log.write", "metrics.write", "telemetry.track", "database.namespace.migrate", "database.namespace.write", "external.objects.detect", "external.objects.read", "external.objects.write", "external.objects.refresh", "plugin.state.read", "plugin.state.write", "events.subscribe", "events.emit", "jobs.schedule", "webhooks.receive", "api.routes.register", "http.outbound", "secrets.read-ref", "environment.drivers.register", "local.folders", "agent.tools.register", "instance.settings.register", "ui.sidebar.register", "ui.page.register", "ui.detailTab.register", "ui.dashboardWidget.register", "ui.commentAnnotation.register", "ui.action.register"]>, "many">;
    ...
    objectReferences: z.ZodOptional<z.ZodArray<z.ZodEffects<z.ZodObject<{
        providerKey: z.ZodString;
        displayName: z.ZodString;
        objectTypes: z.ZodArray<z.ZodString, "many">;
        urlPatterns: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
...
export declare const pluginStateScopeKeySchema: z.ZodObject<{
    ...
    scopeKind: "agent" | "company" | "project" | "issue" | "run" | "instance" | "goal" | "project_workspace";
    stateKey: string;
...
export declare const listPluginStateSchema: z.ZodObject<{
    ...
    namespace?: string | undefined;
    scopeId?: string | undefined;
    scopeKind?: "agent" | "company" | "project" | "issue" | "run" | "instance" | "goal" | "project_workspace" | undefined;
}, {
    namespace?: string | undefined;
    scopeId?: string | undefined;
    scopeKind?: "agent" | "company" | "project" | "issue" | "run" | "instance" | "goal" | "project_workspace" | undefined;
