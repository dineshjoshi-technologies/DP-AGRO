...
export type PipelineCaseConversationSourceReason = "producer_update" | "producer_create" | "automation_link" | "conversation_link" | "work_link";
export type PipelineCaseConversationSourceLinkRole = "automation" | "conversation" | "work";
export type PipelineCaseConversationSourceKind = "explicit_conversation" | "own_producer" | "inherited_parent_producer";
...
export interface PipelineCaseLiveness {
    ...
    reason: "terminal" | "lease_active" | "linked_issue_active" | "linked_issue_waiting" | "linked_issue_blocked" | "case_blocked" | "automation_failed" | "permission_preflight_failed" | "breakdown_pending" | "breakdown_incomplete" | "children_waiting" | "review_waiting" | "no_action_path";
    message: string;
    issue?: {
        id: string;
...
export interface PipelineAutomationRetryBlocker {
    kind: "automation_not_configured" | "previous_stage_not_found" | "target_stage_not_eligible" | "target_case_terminal" | "target_pipeline_archived" | "active_descendants" | "unresolved_blockers" | "permission_preflight_failed";
    message: string;
    caseIds?: string[];
    issueIds?: string[];
...
export type PipelineCaseOutputItem = PipelineCaseDocumentOutputItem | PipelineCaseWorkProductOutputItem | PipelineCaseAttachmentOutputItem;
