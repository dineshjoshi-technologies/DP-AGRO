 ...
 */
export function deriveCaseType(pipeline) {
 ...
 */
export function caseTypeMatchesPipeline(declaredCaseType, pipeline) {
    if (declaredCaseType == null || declaredCaseType === "")
        return true;
    return declaredCaseType === deriveCaseType(pipeline);
}
//# sourceMappingURL=pipeline-case-type.js.map