...
import { issueWorkProductMetadataSchema, createIssueWorkProductSchema, } from "./validators/work-product.js";
...
describe("create issue work product with resource ref", () => {
    it("accepts work product with resourceRef in metadata", () => {
        ...
        expect(result.metadata?.resourceRef?.kind).toBe("workspace_file");
    });
...
//# sourceMappingURL=work-product.test.js.map