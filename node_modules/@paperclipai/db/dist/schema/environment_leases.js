...
export const environmentLeases = pgTable("environment_leases", {
    ...
    companyEnvironmentStatusIdx: index("environment_leases_company_environment_status_idx").on(table.companyId, table.environmentId, table.status),
    companyExecutionWorkspaceIdx: index("environment_leases_company_execution_workspace_idx").on(table.companyId, table.executionWorkspaceId),
...
//# sourceMappingURL=environment_leases.js.map