...
export const companySecretBindings = pgTable("company_secret_bindings", {
    ...
    targetPathUq: uniqueIndex("company_secret_bindings_target_path_uq").on(table.companyId, table.targetType, table.targetId, table.configPath),
}));
//# sourceMappingURL=company_secret_bindings.js.map