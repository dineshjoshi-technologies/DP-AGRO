...
export const cloudUpstreamConnections = pgTable("cloud_upstream_connections", {
...
export const cloudUpstreamRuns = pgTable("cloud_upstream_runs", {
    id: uuid("id").primaryKey().defaultRandom(),
...
//# sourceMappingURL=cloud_upstreams.js.map