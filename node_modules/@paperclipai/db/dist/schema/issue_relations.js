...
export const issueRelations = pgTable("issue_relations", {
    ...
    companyEdgeUq: uniqueIndex("issue_relations_company_edge_uq").on(table.companyId, table.issueId, table.relatedIssueId, table.type),
}));
//# sourceMappingURL=issue_relations.js.map