...
export declare const routineRevisions: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "routine_revisions";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "routine_revisions";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
        ...
        snapshot: import("drizzle-orm/pg-core").PgColumn<{
            ...
            dataType: "json";
            columnType: "PgJsonb";
            data: RoutineRevisionSnapshotV1;
            driverParam: unknown;
            notNull: true;
            hasDefault: false;
            isPrimaryKey: false;
...
export declare const routineRuns: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        routineRevisionId: import("drizzle-orm/pg-core").PgColumn<{
