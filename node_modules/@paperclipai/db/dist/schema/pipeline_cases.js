...
export const pipelineCases = pgTable("pipeline_cases", {
    ...
    fields: jsonb("fields").$type().notNull().default({}),
    workspaceRef: jsonb("workspace_ref").$type(),
    parentCaseId: uuid("parent_case_id").references(() => pipelineCases.id, { onDelete: "set null" }),
...
export const pipelineCaseIssueLinks = pgTable("pipeline_case_issue_links", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id").notNull().references(() => companies.id, { onDelete: "cascade" }),
...
export const pipelineCaseBlockers = pgTable("pipeline_case_blockers", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id").notNull().references(() => companies.id, { onDelete: "cascade" }),
    caseId: uuid("case_id").notNull().references(() => pipelineCases.id, { onDelete: "cascade" }),
...
export const pipelineDocuments = pgTable("pipeline_documents", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id").notNull().references(() => companies.id, { onDelete: "cascade" }),
    pipelineId: uuid("pipeline_id").notNull().references(() => pipelines.id, { onDelete: "cascade" }),
    ...
    companyPipelineKeyUq: uniqueIndex("pipeline_documents_company_pipeline_key_uq").on(table.companyId, table.pipelineId, table.key),
    documentUq: uniqueIndex("pipeline_documents_document_uq").on(table.documentId),
    companyPipelineUpdatedIdx: index("pipeline_documents_company_pipeline_updated_idx").on(table.companyId, table.pipelineId, table.updatedAt),
}));
export const pipelineCaseDocuments = pgTable("pipeline_case_documents", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id").notNull().references(() => companies.id, { onDelete: "cascade" }),
    caseId: uuid("case_id").notNull().references(() => pipelineCases.id, { onDelete: "cascade" }),
    documentId: uuid("document_id").notNull().references(() => documents.id, { onDelete: "cascade" }),
    ...
    companyCaseKeyUq: uniqueIndex("pipeline_case_documents_company_case_key_uq").on(table.companyId, table.caseId, table.key),
    documentUq: uniqueIndex("pipeline_case_documents_document_uq").on(table.documentId),
    companyCaseUpdatedIdx: index("pipeline_case_documents_company_case_updated_idx").on(table.companyId, table.caseId, table.updatedAt),
}));
export const pipelineAutomationExecutions = pgTable("pipeline_automation_executions", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id").notNull().references(() => companies.id, { onDelete: "cascade" }),
    caseId: uuid("case_id").notNull().references(() => pipelineCases.id, { onDelete: "cascade" }),
    ...
    idempotencyUq: uniqueIndex("pipeline_automation_executions_idempotency_uq").on(table.caseId, table.automationId, table.triggeringEventId),
...
//# sourceMappingURL=pipeline_cases.js.map