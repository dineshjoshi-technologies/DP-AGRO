...
export const issuePlanDecompositions = pgTable("issue_plan_decompositions", {
    ...
    companySourceStatusIdx: index("issue_plan_decompositions_company_source_status_idx").on(table.companyId, table.sourceIssueId, table.status),
    ...
    sourceRevisionUq: uniqueIndex("issue_plan_decompositions_source_revision_uq").on(table.companyId, table.sourceIssueId, table.acceptedPlanRevisionId),
}));
//# sourceMappingURL=issue_plan_decompositions.js.map