...
export const pluginManagedResources = pgTable("plugin_managed_resources", {
    ...
    defaultsJson: jsonb("defaults_json").$type().notNull().default({}),
    ...
    companyPluginResourceUq: uniqueIndex("plugin_managed_resources_company_plugin_resource_uq").on(table.companyId, table.pluginId, table.resourceKind, table.resourceKey),
}));
//# sourceMappingURL=plugin_managed_resources.js.map