...
export const issueThreadInteractions = pgTable("issue_thread_interactions", {
    ...
    companyIssueCreatedAtIdx: index("issue_thread_interactions_company_issue_created_at_idx").on(table.companyId, table.issueId, table.createdAt),
    companyIssueStatusIdx: index("issue_thread_interactions_company_issue_status_idx").on(table.companyId, table.issueId, table.status),
...
//# sourceMappingURL=issue_thread_interactions.js.map