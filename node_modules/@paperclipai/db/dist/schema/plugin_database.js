 ...
 */
export const pluginDatabaseNamespaces = pgTable("plugin_database_namespaces", {
    ...
    namespaceMode: text("namespace_mode").$type().notNull().default("schema"),
...
export const pluginMigrations = pgTable("plugin_migrations", {
    ...
    pluginMigrationIdx: uniqueIndex("plugin_migrations_plugin_key_idx").on(table.pluginId, table.migrationKey),
...
//# sourceMappingURL=plugin_database.js.map