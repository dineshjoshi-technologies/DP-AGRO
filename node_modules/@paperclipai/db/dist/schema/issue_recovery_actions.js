...
export const issueRecoveryActions = pgTable("issue_recovery_actions", {
    ...
    wakePolicy: jsonb("wake_policy").$type(),
    monitorPolicy: jsonb("monitor_policy").$type(),
    ...
    companySourceStatusIdx: index("issue_recovery_actions_company_source_status_idx").on(table.companyId, table.sourceIssueId, table.status),
    companyOwnerStatusIdx: index("issue_recovery_actions_company_owner_status_idx").on(table.companyId, table.ownerAgentId, table.status),
    companyRecoveryIssueIdx: index("issue_recovery_actions_company_recovery_issue_idx").on(table.companyId, table.recoveryIssueId),
...
//# sourceMappingURL=issue_recovery_actions.js.map