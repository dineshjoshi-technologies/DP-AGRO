...
export const projectMemberships = pgTable("project_memberships", {
    ...
    companyUserProjectUq: uniqueIndex("project_memberships_company_user_project_uq").on(table.companyId, table.userId, table.projectId),
}));
//# sourceMappingURL=project_memberships.js.map