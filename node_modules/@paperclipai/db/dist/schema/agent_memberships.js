...
export const agentMemberships = pgTable("agent_memberships", {
    ...
    companyUserAgentUq: uniqueIndex("agent_memberships_company_user_agent_uq").on(table.companyId, table.userId, table.agentId),
}));
//# sourceMappingURL=agent_memberships.js.map