...
export const issueTreeHolds = pgTable("issue_tree_holds", {
    ...
    releaseMetadata: jsonb("release_metadata").$type(),
    createdAt: timestamp("created_at", { withTimezone: true }).notNull().defaultNow(),
    updatedAt: timestamp("updated_at", { withTimezone: true }).notNull().defaultNow(),
}, (table) => ({
    companyRootStatusIdx: index("issue_tree_holds_company_root_status_idx").on(table.companyId, table.rootIssueId, table.status),
    companyStatusModeIdx: index("issue_tree_holds_company_status_mode_idx").on(table.companyId, table.status, table.mode),
}));
//# sourceMappingURL=issue_tree_holds.js.map