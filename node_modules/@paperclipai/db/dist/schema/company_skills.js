...
export const companySkills = pgTable("company_skills", {
    ...
    fileInventory: jsonb("file_inventory").$type().notNull().default([]),
    ...
    sharingScope: text("sharing_scope").$type().notNull().default("company"),
    publicShareToken: text("public_share_token"),
    forkedFromSkillId: uuid("forked_from_skill_id").references(() => companySkills.id, { onDelete: "set null" }),
    forkedFromCompanyId: uuid("forked_from_company_id").references(() => companies.id, { onDelete: "set null" }),
    starCount: integer("star_count").notNull().default(0),
    installCount: integer("install_count").notNull().default(0),
    forkCount: integer("fork_count").notNull().default(0),
    currentVersionId: uuid("current_version_id").references(() => companySkillVersions.id, { onDelete: "set null" }),
...
export const companySkillVersions = pgTable("company_skill_versions", {
    id: uuid("id").primaryKey().defaultRandom(),
    ...
    companySkillRevisionUniqueIdx: uniqueIndex("company_skill_versions_skill_revision_idx").on(table.companySkillId, table.revisionNumber),
    companySkillCreatedIdx: index("company_skill_versions_company_skill_created_idx").on(table.companyId, table.companySkillId, table.createdAt),
}));
export const companySkillStars = pgTable("company_skill_stars", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id").notNull().references(() => companies.id, { onDelete: "cascade" }),
    companySkillId: uuid("company_skill_id").notNull().references(() => companySkills.id, { onDelete: "cascade" }),
    ...
    companySkillCreatedIdx: index("company_skill_stars_company_skill_created_idx").on(table.companyId, table.companySkillId, table.createdAt),
}));
export const companySkillComments = pgTable("company_skill_comments", {
    id: uuid("id").primaryKey().defaultRandom(),
    companyId: uuid("company_id").notNull().references(() => companies.id, { onDelete: "cascade" }),
    companySkillId: uuid("company_skill_id").notNull().references(() => companySkills.id, { onDelete: "cascade" }),
    parentCommentId: uuid("parent_comment_id").references(() => companySkillComments.id, { onDelete: "set null" }),
    authorAgentId: uuid("author_agent_id").references(() => agents.id, { onDelete: "set null" }),
    authorUserId: text("author_user_id"),
    ...
    companySkillCreatedIdx: index("company_skill_comments_company_skill_created_idx").on(table.companyId, table.companySkillId, table.createdAt),
    parentIdx: index("company_skill_comments_parent_idx").on(table.parentCommentId),
}));
//# sourceMappingURL=company_skills.js.map