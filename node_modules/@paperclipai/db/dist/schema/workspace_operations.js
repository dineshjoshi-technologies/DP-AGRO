...
export const workspaceOperations = pgTable("workspace_operations", {
    ...
    companyRunStartedIdx: index("workspace_operations_company_run_started_idx").on(table.companyId, table.heartbeatRunId, table.startedAt),
    ...
    companyWorkspaceIssueStartedIdx: index("workspace_operations_company_workspace_issue_started_idx").on(table.companyId, table.executionWorkspaceId, table.issueId, table.startedAt),
}));
//# sourceMappingURL=workspace_operations.js.map