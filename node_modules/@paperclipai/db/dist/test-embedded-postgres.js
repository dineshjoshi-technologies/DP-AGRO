...
async function getAvailablePort() {
    ...
    throw new Error(`Failed to allocate embedded Postgres test port outside reserved Paperclip ports: ${[
        ...reservedPorts,
    ].join(", ")}`);
}
async function createEmbeddedPostgresTestInstance(tempDirPrefix) {
...
function cleanupEmbeddedPostgresTestDirs(dataDir) {
...
async function probeEmbeddedPostgresSupport() {
    ...
    let instance = null;
    try {
        const created = await createEmbeddedPostgresTestInstance("paperclip-embedded-postgres-probe-");
