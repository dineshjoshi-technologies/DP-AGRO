    ...
    try {
        ...
        if (executionTargetIsRemote) {
            try {
                ...
                restoreRemoteWorkspace = () => preparedRemoteRuntime.restoreWorkspace((line) => onLog("stdout", line));
        ...
        const commandNotes = (() => {
            ...
            notes.push(`Appended instructions + path directive to system prompt (relative references from ${instructionsFileDir}).`);
            return notes;
        })();
