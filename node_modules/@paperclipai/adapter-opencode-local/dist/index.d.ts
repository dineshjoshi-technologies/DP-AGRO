...
export declare const DEFAULT_OPENCODE_CHEAP_MODEL = "openai/gpt-5.1-codex-mini";
export declare function buildOpenCodeModelProfiles(env?: NodeJS.ProcessEnv): AdapterModelProfileDefinition[];
