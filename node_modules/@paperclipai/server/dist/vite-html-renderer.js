...
function injectViteDevPreamble(html) {
    ...
    if (injectedHtml.includes(VITE_CLIENT_TAG))
        return injectedHtml;
...
export function createCachedViteHtmlRenderer(opts) {
    ...
    const brandHtml = opts.brandHtml ?? ((html) => html);
    let cachedHtml = null;
    function loadHtml() {
        if (cachedHtml === null) {
    ...
    function onWatchEvent(filePath) {
...
//# sourceMappingURL=vite-html-renderer.js.map