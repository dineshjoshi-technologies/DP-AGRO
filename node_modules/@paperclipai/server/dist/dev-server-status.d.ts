...
export declare function getDevServerRestartRequestFilePath(env?: NodeJS.ProcessEnv): string | null;
export declare function writeDevServerRestartRequest(request: DevServerRestartRequest, env?: NodeJS.ProcessEnv): boolean;
