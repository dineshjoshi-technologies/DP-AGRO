...
export declare function isDatabaseConnectionUnavailableError(err: unknown): boolean;
export declare function resolveViteHmrPort(serverPort: number): number;
export declare function resolveViteHmrHost(bindHost: string): string | undefined;
