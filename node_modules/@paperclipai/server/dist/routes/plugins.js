...
import { getPluginUiContributionMetadata, listMissingDeclaredPluginEntrypoints, REPO_ROOT, } from "../services/plugin-loader.js";
import { logActivity } from "../services/activity-log.js";
import { publishGlobalLiveEvent } from "../services/live-events.js";
import { issueService } from "../services/issues.js";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@paperclipai/plugin-sdk";
import { assertAuthenticated, assertBoard, assertBoardOrAgent, assertBoardOrgAccess, assertCompanyAccess, assertInstanceAdmin, getActorInfo, } from "./authz.js";
...
function manifestSourcePath(packageRoot, pkgJson) {
    ...
    const manifestPath = paperclipPlugin.manifest;
...
async function discoverBundledPlugins() {
    ...
    return bundledPlugins.sort((left, right) => {
        if (left.entry.tag !== right.entry.tag)
            return left.entry.tag === "first-party" ? -1 : 1;
...
export function pluginRoutes(db, loader, jobDeps, webhookDeps, toolDeps, bridgeDeps) {
    ...
    function performActionActorContext(req, companyId) {
    ...
    function actionParamsWithAuthorizedCompanyScope(params, companyId) {
        const base = params ?? {};
