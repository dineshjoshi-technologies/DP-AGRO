...
import { createCostEventSchema, createFinanceEventSchema, normalizeIssueIdentifier, resolveBudgetIncidentSchema, updateBudgetSchema, upsertBudgetPolicySchema, } from "@paperclipai/shared";
import { validate } from "../middleware/validate.js";
import { budgetService, costService, financeService, companyService, agentService, issueService, heartbeatService, accessService, logActivity, } from "../services/index.js";
...
export function costRoutes(db, options = {}) {
    const router = Router();
    ...
    async function assertCompanyCostReadAllowed(req, res, companyId) {
    ...
    router.get("/companies/:companyId/costs/summary", async (req, res) => {
        const companyId = req.params.companyId;
        assertCompanyAccess(req, companyId);
        if (!(await assertCompanyCostReadAllowed(req, res, companyId)))
            return;
    ...
    router.get("/issues/:id/cost-summary", async (req, res) => {
        ...
        if (!(await assertIssueCostReadAllowed(req, res, issue)))
            return;
