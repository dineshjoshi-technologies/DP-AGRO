...
export function activityRoutes(db) {
    ...
    async function assertCompanyScopeReadAllowed(req, res, companyId) {
    ...
    router.get("/companies/:companyId/activity", async (req, res) => {
        ...
        if (!(await assertCompanyScopeReadAllowed(req, res, companyId)))
            return;
        const filters = {
            companyId,
    ...
    router.get("/heartbeat-runs/:runId/issues", async (req, res) => {
        ...
        if (!(await assertCompanyScopeReadAllowed(req, res, run.companyId)))
            return;
