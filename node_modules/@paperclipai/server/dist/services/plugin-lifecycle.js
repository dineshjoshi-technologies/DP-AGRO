    ...
    return {
        ...
        async restartWorker(pluginId) {
            ...
            if (supportsRuntimeActivation) {
                log.info({ pluginId, pluginKey: plugin.pluginKey }, "plugin lifecycle: reloading plugin (re-reading manifest, re-applying pending migrations, restarting worker)");
                ...
                log.info({ pluginId, pluginKey: plugin.pluginKey }, "plugin lifecycle: restarting worker (runtime services unavailable; skipping migration re-apply)");
