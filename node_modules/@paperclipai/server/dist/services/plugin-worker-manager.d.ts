...
import type { WorkerHostCallContext, HostToWorkerMethodName, HostToWorkerMethods, WorkerToHostMethodName, WorkerToHostMethods } from "@paperclipai/plugin-sdk";
/**
 ...
 */
export type WorkerToHostHandler<M extends WorkerToHostMethodName> = (params: WorkerToHostMethods[M][0], context?: WorkerHostCallContext) => Promise<WorkerToHostMethods[M][1]>;
/**
