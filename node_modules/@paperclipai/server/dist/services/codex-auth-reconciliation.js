 ...
 * routes/agents.ts.
 */
function readPlainEnvValue(value) {
 ...
 *    auth symlink.
 */
function classifyApiKeyBinding(value) {
 ...
 */
export async function reconcileCodexLocalManagedHomesOnStartup(db) {
    const summary = {
        scanned: 0,
        seeded: 0,
        alreadySeeded: 0,
        ...
        try {
            ...
            switch (result.status) {
                case "seeded":
                    ...
                    logger.info({ agentId: row.id, companyId: row.companyId, home: result.home }, "seeded auth into already-isolated codex_local managed home");
                    break;
                case "already_seeded":
...
//# sourceMappingURL=codex-auth-reconciliation.js.map