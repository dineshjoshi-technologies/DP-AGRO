...
export declare const BUNDLED_LOCAL_PLUGIN_ROOT: string;
export declare const STANDALONE_BUNDLED_PLUGIN_ROOT: string;
export declare const LOCAL_PLUGIN_AUTOBUILD_TIMEOUT_MS = 120000;
/**
...
export declare function buildPluginWorkerEnv(input: {
...
export declare function isRepoBundledPluginPath(packageRoot: string, options?: {
    repoRoot?: string;
}): boolean;
export declare function isStandaloneBundledPluginPath(packageRoot: string, options?: {
    repoRoot?: string;
}): boolean;
export declare function resolveDeclaredPluginEntrypoints(packageRoot: string, pkgJson: Record<string, unknown>): PluginEntrypointPath[];
export declare function listMissingDeclaredPluginEntrypoints(packageRoot: string, pkgJson: Record<string, unknown>): PluginEntrypointPath[];
export declare function ensureLocalPluginBuilt(packageRoot: string, pkgJson: Record<string, unknown>, options?: {
    processEnv?: NodeJS.ProcessEnv;
    repoRoot?: string;
    execFileAsyncImpl?: (file: string, args: readonly string[], options: {
        cwd: string;
        timeout: number;
    }) => Promise<{
        stdout: string;
