...
describe("successful run handoff decision", () => {
    ...
    it("does not queue when the issue already has a valid disposition", () => {
        expect(decide({ issue: { ...issue, status: "done" } })).toEqual({
            kind: "skip",
    ...
    it("does not queue when a successful run records an accepted next-action path", () => {
        expect(decide({ issue: { ...issue, status: "in_review" } })).toEqual({
            kind: "skip",
    ...
    it("does not treat adapter or runtime failures as missing-disposition handoffs", () => {
        expect(decide({ run: { ...run, status: "failed", errorCode: "adapter_failed" } })).toEqual({
            kind: "skip",
            reason: "source run did not succeed",
        });
    });
    it("does not queue on missing-comment retry bookkeeping runs", () => {
        expect(decide({ run: { ...run, issueCommentStatus: "retry_exhausted" } })).toEqual({
            kind: "skip",
    ...
    it("builds the exhausted system notice with recovery metadata", () => {
        const notice = buildSuccessfulRunHandoffExhaustedNotice({
            ...
            sourceRun: { id: "22222222-2222-4222-8222-222222222222", status: "succeeded" },
            correctiveRun: { id: "44444444-4444-4444-8444-444444444444", status: "failed" },
            sourceAssignee: { id: "33333333-3333-4333-8333-333333333333", name: "CodexCoder" },
            recoveryIssue: {
            ...
            recoveryOwner: { id: "66666666-6666-4666-8666-666666666666", name: "CTO" },
...
//# sourceMappingURL=successful-run-handoff.test.js.map