...
import { KUBERNETES_PROVIDER_KEY, evaluateExecutionAllowlist, } from "./execution-allowlist.js";
const localEnv = {
    driver: "local",
    provider: null,
};
...
describe("evaluateExecutionAllowlist", () => {
    ...
    describe('executionMode "kubernetes" (forced sandbox)', () => {
        ...
        it("DENIES a sandbox driver with no provider", () => {
            const result = evaluateExecutionAllowlist({ executionMode: "kubernetes" }, { driver: "sandbox", provider: null });
            expect(result.allowed).toBe(false);
        });
    });
...
//# sourceMappingURL=execution-allowlist.test.js.map