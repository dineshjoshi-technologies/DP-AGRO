...
export declare const KUBERNETES_PROVIDER_KEY: "kubernetes";
/**
...
export declare function isExecutionForcedToKubernetes(policy: ExecutionPolicy | null | undefined): boolean;
/**
 ...
 */
export declare function isKubernetesSandboxEnvironment(candidate: ExecutionEnvironmentCandidate): boolean;
/**
 ...
 * allowed.
 */
export declare function evaluateExecutionAllowlist(policy: ExecutionPolicy | null | undefined, candidate: ExecutionEnvironmentCandidate): ExecutionAllowlistDecision;
//# sourceMappingURL=execution-allowlist.d.ts.map