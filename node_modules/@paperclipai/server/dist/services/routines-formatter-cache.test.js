...
describe("nextCronTickInTimeZone formatter caching", () => {
    ...
    it("computes the next occurrence of a sparse monthly cron correctly", () => {
        const next = nextCronTickInTimeZone("30 6 1 * *", "America/New_York", new Date("2026-06-02T00:00:00Z"));
    ...
    it("does not construct a new Intl.DateTimeFormat per minute-step", () => {
        ...
        const next = nextCronTickInTimeZone("0 12 1 * *", "Pacific/Kiritimati", new Date("2026-06-01T12:01:00Z"));
        expect(next).not.toBeNull();
...
//# sourceMappingURL=routines-formatter-cache.test.js.map