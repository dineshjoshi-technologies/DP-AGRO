import type { SecretProvider, SecretProviderConfigDiscoveryPreviewResult, SecretProviderDescriptor } from "@paperclipai/shared";
...
export type SecretProviderClientErrorCode = "access_denied" | "throttled" | "not_found" | "conflict" | "invalid_request" | "provider_unavailable" | "provider_error";
...
export declare class SecretProviderClientError extends Error {
...
export declare function isSecretProviderClientError(error: unknown): error is SecretProviderClientError;
