...
function enforceKeyFilePermissionsBestEffort(keyPath) {
    try {
...
function prepareManagedVersion(value) {
...
async function inspectLocalEncryptedHealth() {
    ...
    const warnings = mode !== null && (mode & 0o077) !== 0
...
function decryptValue(masterKey, material) {
    ...
    try {
        ...
        throw new Error(`Secret decryption failed (master key fingerprint: ${keyFingerprint}). ` +
