...
export async function resolveCloudTenantActor(db, req) {
...
function requiredCloudHeader(req, name) {
...
function stackMembershipRole(value) {
...
function cloudTenantCompanyId(stackId) {
...
function issuePrefixForCloudStack(stackId) {
