...
\r	\v              \u2028\u2029  　\uFEFF`.split("");function Kd(t){const e=typeof t=="string"?new RegExp(t):t;return nm.some(n=>e.test(n))}function Da(t){return t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function rm(t,e){const n=im(t),r=e.match(n);return!!r&&r[0].length>0}function im(t){typeof t=="string"&&(t=new RegExp(t));const e=t,n=t.source;let r=0;function i(){let s="",a;function o(l){s+=n.substr(r,l),r+=l}function c(l){s+="(?:"+n.substr(r,l)+"|$)",r+=l}for(;r<n.length;)switch(n[r]){case"\\":switch(n[r+1]){case"c":c(3);break;case"x":c(4);break;case"u":e.unicode?n[r+2]==="{"?c(n.indexOf("}",r)-r+1):c(6):c(2);break;case"p":case"P":e.unicode?c(n.indexOf("}",r)-r+1):c(2);break;case"k":c(n.indexOf(">",r)-r+1);break;default:c(2);break}break;case"[":a=/\[(?:\\.|.)*?\]/g,a.lastIndex=r,a=a.exec(n)||[],c(a[0].length);break;case"|":case"^":case"$":case"*":case"+":case"?":o(1);break;case"{":a=/\{\d+,?\d*\}/g,a.lastIndex=r,a=a.exec(n),a?o(a[0].length):c(1);break;case"(":if(n[r+1]==="?")switch(n[r+2]){case":":s+="(?:",r+=3,s+=i()+"|$)";break;case"=":s+="(?=",r+=3,s+=i()+")";break;case"!":a=r,r+=3,i(),s+=n.substr(a,r-a);break;case"<":switch(n[r+3]){case"=":case"!":a=r,r+=4,i(),s+=n.substr(a,r-a);break;default:o(n.indexOf(">",r)-r+1),s+=i()+"|$)";break}break}else o(1),s+=i()+"|$)";break;case")":return++r,s;default:c(1);break}return s}return new RegExp(i(),t.flags)}function sm(t){return t.rules.find(e=>sn(e)&&e.entry)}function am(t){return t.rules.filter(e=>an(e)&&e.hidden)}function Hd(t,e){const n=new Set,r=sm(t);if(!r)return new Set(t.rules);const i=[r].concat(am(t));for(const a of i)Yd(a,n,e);const s=new Set;for(const a of t.rules)(n.has(a.name)||an(a)&&a.hidden)&&s.add(a);return s}function Yd(t,e,n){e.add(t.name),is(t).forEach(r=>{if(Vn(r)||n){const i=r.rule.ref;i&&!e.has(i.name)&&Yd(i,e,n)}})}function om(t){if(t.terminal)return t.terminal;if(t.type.ref){const e=Jd(t.type.ref);return e==null?void 0:e.terminal}}function cm(t){return t.hidden&&!Kd(ll(t))}function lm(t,e){return!t||!e?[]:cl(t,e,t.astNode,!0)}function Xd(t,e,n){if(!t||!e)return;const r=cl(t,e,t.astNode,!0);if(r.length!==0)return n!==void 0?n=Math.max(0,Math.min(n,r.length-1)):n=0,r[n]}function cl(t,e,n,r){if(!r){const i=Pa(t.grammarSource,Bn);if(i&&i.feature===e)return[t]}return Wi(t)&&t.astNode===n?t.content.flatMap(i=>cl(i,e,n,!1)):[]}function um(t,e,n){if(!t)return;const r=dm(t,e,t==null?void 0:t.astNode);if(r.length!==0)return n!==void 0?n=Math.max(0,Math.min(n,r.length-1)):n=0,r[n]}function dm(t,e,n){if(t.astNode!==n)return[];if(Wn(t.grammarSource)&&t.grammarSource.value===e)return[t];const r=wo(t).iterator();let i;const s=[];do if(i=r.next(),!i.done){const a=i.value;a.astNode===n?Wn(a.grammarSource)&&a.grammarSource.value===e&&s.push(a):r.prune()}while(!i.done);return s}function fm(t){var n;const e=t.astNode;for(;e===((n=t.container)==null?void 0:n.astNode);){const r=Pa(t.grammarSource,Bn);if(r)return r;t=t.container}}function Jd(t){let e=t;return jd(e)&&(La(e.$container)?e=e.$container.$container:ss(e.$container)?e=e.$container:as(e.$container)),Qd(t,e,new Map)}function Qd(t,e,n){var i;function r(s,a){let o;return Pa(s,Bn)||(o=Qd(a,a,n)),n.set(t,o),o}if(n.has(t))return n.get(t);n.set(t,void 0);for(const s of is(e)){if(Bn(s)&&s.feature.toLowerCase()==="name")return n.set(t,s),s;if(Vn(s)&&sn(s.rule.ref))return r(s,s.rule.ref);if(Dp(s)&&((i=s.typeRef)!=null&&i.ref))return r(s,s.typeRef.ref)}}function Zd(t){return ef(t,new Set)}function ef(t,e){if(e.has(t))return!0;e.add(t);for(const n of is(t))if(Vn(n)){if(!n.rule.ref||sn(n.rule.ref)&&!ef(n.rule.ref,e)||la(n.rule.ref))return!1}else{if(Bn(n))return!1;if(La(n))return!1}return!!t.definition}function tf(t){if(!an(t)){if(t.inferredType)return t.inferredType.name;if(t.dataType)return t.dataType;if(t.returnType){const e=t.returnType.ref;if(e)return e.name}}}function Vi(t){if(ss(t))return sn(t)&&Zd(t)?t.name:tf(t)??t.name;if(_p(t)||Up(t)||xp(t))return t.name;if(La(t)){const e=hm(t);if(e)return e}else if(jd(t))return t.name;throw new Error("Cannot get name of Unknown Type")}function hm(t){var e;if(t.inferredType)return t.inferredType.name;if((e=t.type)!=null&&e.ref)return Vi(t.type.ref)}function pm(t){var e;return an(t)?((e=t.type)==null?void 0:e.name)??"string":tf(t)??t.name}function ll(t){const e={s:!1,i:!1,u:!1},n=Xr(t.definition,e),r=Object.entries(e).filter(([,i])=>i).map(([i])=>i).join("");return new RegExp(n,r)}const ul=/[\s\S]/.source;function Xr(t,e){var n;if(Mp(t))return mm(t);if(Fp(t))return gm(t);if(kp(t))return Rm(t);if(Gp(t)){const r=t.rule.ref;if(!r)throw new Error("Missing rule reference.");return en(Xr(r.definition),{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized})}else{if(Ip(t))return Tm(t);if(qp(t))return ym(t);if(Op(t)){const r=t.regex.lastIndexOf("/"),i=t.regex.substring(1,r),s=t.regex.substring(r+1);return e&&(e.i=s.includes("i"),e.s=s.includes("s"),e.u=s.includes("u")),en(i,{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized,wrap:!1})}else{if(jp(t))return en(ul,{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized});throw new Error(`Invalid terminal element: ${t==null?void 0:t.$type}, ${(n=t==null?void 0:t.$cstNode)==null?void 0:n.text}`)}}}function mm(t){return en(t.elements.map(e=>Xr(e)).join("|"),{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized,wrap:!1})}function gm(t){return en(t.elements.map(e=>Xr(e)).join(""),{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized,wrap:!1})}function ym(t){return en(`${ul}*?${Xr(t.terminal)}`,{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized})}function Tm(t){return en(`(?!${Xr(t.terminal)})${ul}*?`,{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized})}function Rm(t){return t.right?en(`[${Qa(t.left)}-${Qa(t.right)}]`,{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized,wrap:!1}):en(Qa(t.left),{cardinality:t.cardinality,lookahead:t.lookahead,parenthesized:t.parenthesized,wrap:!1})}function Qa(t){return Da(t.value)}function en(t,e){return(e.parenthesized||e.lookahead||e.wrap!==!1)&&(t=`(${e.lookahead??(e.parenthesized?"":"?:")}${t})`),e.cardinality?`${t}${e.cardinality}`:t}function vm(t){const e=[],n=t.Grammar;for(const r of n.rules)an(r)&&cm(r)&&tm(ll(r))&&e.push(r.name);return{multilineCommentRules:e,nameRegexp:Vp}}function nf(t){const e=new Date().getTime(),n=t();return{time:new Date().getTime()-e,value:n}}function rf(t){function e(){}e.prototype=t;const n=new e;function r(){return typeof n.bar}return r(),r(),t}function Em(t){return Am(t)?t.LABEL:t.name}function Am(t){return nt(t.LABEL)&&t.LABEL!==""}class xt{get definition(){return this._definition}set definition(e){this._definition=e}constructor(e){this._definition=e}accept(e){e.visit(this),q(this.definition,n=>{n.accept(e)})}}class Qe extends xt{constructor(e){super([]),this.idx=1,ft(this,wt(e,n=>n!==void 0))}set definition(e){}get definition(){return this.referencedRule!==void 0?this.referencedRule.definition:[]}accept(e){e.visit(this)}}class Jr extends xt{constructor(e){super(e.definition),this.orgText="",ft(this,wt(e,n=>n!==void 0))}}class rt extends xt{constructor(e){super(e.definition),this.ignoreAmbiguities=!1,ft(this,wt(e,n=>n!==void 0))}}let ze=class extends xt{constructor(e){super(e.definition),this.idx=1,ft(this,wt(e,n=>n!==void 0))}};class pt extends xt{constructor(e){super(e.definition),this.idx=1,ft(this,wt(e,n=>n!==void 0))}}class mt extends xt{constructor(e){super(e.definition),this.idx=1,ft(this,wt(e,n=>n!==void 0))}}class Ae extends xt{constructor(e){super(e.definition),this.idx=1,ft(this,wt(e,n=>n!==void 0))}}class it extends xt{constructor(e){super(e.definition),this.idx=1,ft(this,wt(e,n=>n!==void 0))}}class st extends xt{get definition(){return this._definition}set definition(e){this._definition=e}constructor(e){super(e.definition),this.idx=1,this.ignoreAmbiguities=!1,this.hasPredicates=!1,ft(this,wt(e,n=>n!==void 0))}}class ue{constructor(e){this.idx=1,ft(this,wt(e,n=>n!==void 0))}accept(e){e.visit(this)}}function $m(t){return M(t,Zs)}function Zs(t){function e(n){return M(n,Zs)}if(t instanceof Qe){const n={type:"NonTerminal",name:t.nonTerminalName,idx:t.idx};return nt(t.label)&&(n.label=t.label),n}else{if(t instanceof rt)return{type:"Alternative",definition:e(t.definition)};if(t instanceof ze)return{type:"Option",idx:t.idx,definition:e(t.definition)};if(t instanceof pt)return{type:"RepetitionMandatory",idx:t.idx,definition:e(t.definition)};if(t instanceof mt)return{type:"RepetitionMandatoryWithSeparator",idx:t.idx,separator:Zs(new ue({terminalType:t.separator})),definition:e(t.definition)};if(t instanceof it)return{type:"RepetitionWithSeparator",idx:t.idx,separator:Zs(new ue({terminalType:t.separator})),definition:e(t.definition)};if(t instanceof Ae)return{type:"Repetition",idx:t.idx,definition:e(t.definition)};if(t instanceof st)return{type:"Alternation",idx:t.idx,definition:e(t.definition)};if(t instanceof ue){const n={type:"Terminal",name:t.terminalType.name,label:Em(t.terminalType),idx:t.idx};nt(t.label)&&(n.terminalLabel=t.label);const r=t.terminalType.PATTERN;return t.terminalType.PATTERN&&(n.pattern=nn(r)?r.source:r),n}else{if(t instanceof Jr)return{type:"Rule",name:t.name,orgText:t.orgText,definition:e(t.definition)};throw Error("non exhaustive match")}}}class Qr{visit(e){const n=e;switch(n.constructor){case Qe:return this.visitNonTerminal(n);case rt:return this.visitAlternative(n);case ze:return this.visitOption(n);case pt:return this.visitRepetitionMandatory(n);case mt:return this.visitRepetitionMandatoryWithSeparator(n);case it:return this.visitRepetitionWithSeparator(n);case Ae:return this.visitRepetition(n);case st:return this.visitAlternation(n);case ue:return this.visitTerminal(n);case Jr:return this.visitRule(n);default:throw Error("non exhaustive match")}}visitNonTerminal(e){}visitAlternative(e){}visitOption(e){}visitRepetition(e){}visitRepetitionMandatory(e){}visitRepetitionMandatoryWithSeparator(e){}visitRepetitionWithSeparator(e){}visitAlternation(e){}visitTerminal(e){}visitRule(e){}}function Sm(t){return t instanceof rt||t instanceof ze||t instanceof Ae||t instanceof pt||t instanceof mt||t instanceof it||t instanceof ue||t instanceof Jr}function ha(t,e=[]){return t instanceof ze||t instanceof Ae||t instanceof it?!0:t instanceof st?xd(t.definition,r=>ha(r,e)):t instanceof Qe&&et(e,t)?!1:t instanceof xt?(t instanceof Qe&&e.push(t),St(t.definition,r=>ha(r,e))):!1}function Cm(t){return t instanceof st}function Pt(t){if(t instanceof Qe)return"SUBRULE";if(t instanceof ze)return"OPTION";if(t instanceof st)return"OR";if(t instanceof pt)return"AT_LEAST_ONE";if(t instanceof mt)return"AT_LEAST_ONE_SEP";if(t instanceof it)return"MANY_SEP";if(t instanceof Ae)return"MANY";if(t instanceof ue)return"CONSUME";throw Error("non exhaustive match")}class Ma{walk(e,n=[]){q(e.definition,(r,i)=>{const s=Ge(e.definition,i+1);if(r instanceof Qe)this.walkProdRef(r,s,n);else if(r instanceof ue)this.walkTerminal(r,s,n);else if(r instanceof rt)this.walkFlat(r,s,n);else if(r instanceof ze)this.walkOption(r,s,n);else if(r instanceof pt)this.walkAtLeastOne(r,s,n);else if(r instanceof mt)this.walkAtLeastOneSep(r,s,n);else if(r instanceof it)this.walkManySep(r,s,n);else if(r instanceof Ae)this.walkMany(r,s,n);else if(r instanceof st)this.walkOr(r,s,n);else throw Error("non exhaustive match")})}walkTerminal(e,n,r){}walkProdRef(e,n,r){}walkFlat(e,n,r){const i=n.concat(r);this.walk(e,i)}walkOption(e,n,r){const i=n.concat(r);this.walk(e,i)}walkAtLeastOne(e,n,r){const i=[new ze({definition:e.definition})].concat(n,r);this.walk(e,i)}walkAtLeastOneSep(e,n,r){const i=Bl(e,n,r);this.walk(e,i)}walkMany(e,n,r){const i=[new ze({definition:e.definition})].concat(n,r);this.walk(e,i)}walkManySep(e,n,r){const i=Bl(e,n,r);this.walk(e,i)}walkOr(e,n,r){const i=n.concat(r);q(e.definition,s=>{const a=new rt({definition:[s]});this.walk(a,i)})}}function Bl(t,e,n){return[new ze({definition:[new ue({terminalType:t.separator})].concat(t.definition)})].concat(e,n)}function os(t){if(t instanceof Qe)return os(t.referencedRule);if(t instanceof ue)return Nm(t);if(Sm(t))return km(t);if(Cm(t))return wm(t);throw Error("non exhaustive match")}function km(t){let e=[];const n=t.definition;let r=0,i=n.length>r,s,a=!0;for(;i&&a;)s=n[r],a=ha(s),e=e.concat(os(s)),r=r+1,i=n.length>r;return il(e)}function wm(t){const e=M(t.definition,n=>os(n));return il(yt(e))}function Nm(t){return[t.terminalType]}const sf="_~IN~_";class bm extends Ma{constructor(e){super(),this.topProd=e,this.follows={}}startWalking(){return this.walk(this.topProd),this.follows}walkTerminal(e,n,r){}walkProdRef(e,n,r){const i=Im(e.referencedRule,e.idx)+this.topProd.name,s=n.concat(r),a=new rt({definition:s}),o=os(a);this.follows[i]=o}}function _m(t){const e={};return q(t,n=>{const r=new bm(n).startWalking();ft(e,r)}),e}function Im(t,e){return t.name+e+sf}let ea={};const Pm=new Vd;function Fa(t){const e=t.toString();if(ea.hasOwnProperty(e))return ea[e];{const n=Pm.pattern(e);return ea[e]=n,n}}function Lm(){ea={}}const af="Complement Sets are not supported for first char optimization",pa=`Unable to use "first char" lexer optimizations:
`;function Om(t,e=!1){try{const n=Fa(t);return bo(n.value,{},n.flags.ignoreCase)}catch(n){if(n.message===af)e&&(`${pa}${t.toString()}`,void 0);else{let r="";e&&(r=`
	This will disable the lexer's first char optimizations.
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#REGEXP_PARSING for details.`),`${pa}
	Failed parsing: < ${t.toString()} >
	Using the @chevrotain/regexp-to-ast library
	Please open an issue at: https://github.com/chevrotain/chevrotain/issues`+r}}return[]}function bo(t,e,n){switch(t.type){case"Disjunction":for(let i=0;i<t.value.length;i++)bo(t.value[i],e,n);break;case"Alternative":const r=t.value;for(let i=0;i<r.length;i++){const s=r[i];switch(s.type){case"EndAnchor":case"GroupBackReference":case"Lookahead":case"NegativeLookahead":case"Lookbehind":case"NegativeLookbehind":case"StartAnchor":case"WordBoundary":case"NonWordBoundary":continue}const a=s;switch(a.type){case"Character":xs(a.value,e,n);break;case"Set":if(a.complement===!0)throw Error(af);q(a.value,c=>{if(typeof c=="number")xs(c,e,n);else{const l=c;if(n===!0)for(let u=l.from;u<=l.to;u++)xs(u,e,n);else{for(let u=l.from;u<=l.to&&u<Gi;u++)xs(u,e,n);if(l.to>=Gi){const u=l.from>=Gi?l.from:Gi,f=l.to,g=fn(u),h=fn(f);for(let E=g;E<=h;E++)e[E]=E}}}});break;case"Group":bo(a.value,e,n);break;default:throw Error("Non Exhaustive Match")}const o=a.quantifier!==void 0&&a.quantifier.atLeast===0;if(a.type==="Group"&&_o(a)===!1||a.type!=="Group"&&o===!1)break}break;default:throw Error("non exhaustive match!")}return Pe(e)}function xs(t,e,n){const r=fn(t);e[r]=r,n===!0&&xm(t,e)}function xm(t,e){const n=String.fromCharCode(t),r=n.toUpperCase();if(r!==n){const i=fn(r.charCodeAt(0));e[i]=i}else{const i=n.toLowerCase();if(i!==n){const s=fn(i.charCodeAt(0));e[s]=s}}}function Wl(t,e){return zr(t.value,n=>{if(typeof n=="number")return et(e,n);{const r=n;return zr(e,i=>r.from<=i&&i<=r.to)!==void 0}})}function _o(t){const e=t.quantifier;return e&&e.atLeast===0?!0:t.value?je(t.value)?St(t.value,_o):_o(t.value):!1}class Dm extends xa{constructor(e){super(),this.targetCharCodes=e,this.found=!1}visitChildren(e){if(this.found!==!0){switch(e.type){case"Lookahead":this.visitLookahead(e);return;case"NegativeLookahead":this.visitNegativeLookahead(e);return;case"Lookbehind":this.visitLookbehind(e);return;case"NegativeLookbehind":this.visitNegativeLookbehind(e);return}super.visitChildren(e)}}visitCharacter(e){et(this.targetCharCodes,e.value)&&(this.found=!0)}visitSet(e){e.complement?Wl(e,this.targetCharCodes)===void 0&&(this.found=!0):Wl(e,this.targetCharCodes)!==void 0&&(this.found=!0)}}function dl(t,e){if(e instanceof RegExp){const n=Fa(e),r=new Dm(t);return r.visit(n),r.found}else return zr(e,n=>et(t,n.charCodeAt(0)))!==void 0}const Kn="PATTERN",Fi="defaultMode",Ds="modes";function Mm(t,e){e=rl(e,{debug:!1,safeMode:!1,positionTracking:"full",lineTerminatorCharacters:["\r",`
`],tracer:(k,C)=>C()});const n=e.tracer;n("initCharCodeToOptimizedIndexMap",()=>{og()});let r;n("Reject Lexer.NA",()=>{r=Ia(t,k=>k[Kn]===tt.NA)});let i=!1,s;n("Transform Patterns",()=>{i=!1,s=M(r,k=>{const C=k[Kn];if(nn(C)){const I=C.source;return I.length===1&&I!=="^"&&I!=="$"&&I!=="."&&!C.ignoreCase?I:I.length===2&&I[0]==="\\"&&!et(["d","D","s","S","t","r","n","t","0","c","b","B","f","v","w","W"],I[1])?I[1]:Vl(C)}else{if(Xn(C))return i=!0,{exec:C};if(typeof C=="object")return i=!0,C;if(typeof C=="string"){if(C.length===1)return C;{const I=C.replace(/[\\^$.*+?()[\]{}|]/g,"\\$&"),H=new RegExp(I);return Vl(H)}}else throw Error("non exhaustive match")}})});let a,o,c,l,u;n("misc mapping",()=>{a=M(r,k=>k.tokenTypeIdx),o=M(r,k=>{const C=k.GROUP;if(C!==tt.SKIPPED){if(nt(C))return C;if(tn(C))return!1;throw Error("non exhaustive match")}}),c=M(r,k=>{const C=k.LONGER_ALT;if(C)return je(C)?M(C,H=>_l(r,H)):[_l(r,C)]}),l=M(r,k=>k.PUSH_MODE),u=M(r,k=>z(k,"POP_MODE"))});let f;n("Line Terminator Handling",()=>{const k=lf(e.lineTerminatorCharacters);f=M(r,C=>!1),e.positionTracking!=="onlyOffset"&&(f=M(r,C=>z(C,"LINE_BREAKS")?!!C.LINE_BREAKS:cf(C,k)===!1&&dl(k,C.PATTERN)))});let g,h,E,N;n("Misc Mapping #2",()=>{g=M(r,of),h=M(s,ig),E=Je(r,(k,C)=>{const I=C.GROUP;return nt(I)&&I!==tt.SKIPPED&&(k[I]=[]),k},{}),N=M(s,(k,C)=>({pattern:s[C],longerAlt:c[C],canLineTerminator:f[C],isCustom:g[C],short:h[C],group:o[C],push:l[C],pop:u[C],tokenTypeIdx:a[C],tokenType:r[C]}))});let _=!0,S=[];return e.safeMode||n("First Char Optimization",()=>{S=Je(r,(k,C,I)=>{if(typeof C.PATTERN=="string"){const H=C.PATTERN.charCodeAt(0),K=fn(H);Za(k,K,N[I])}else if(je(C.START_CHARS_HINT)){let H;q(C.START_CHARS_HINT,K=>{const J=typeof K=="string"?K.charCodeAt(0):K,oe=fn(J);H!==oe&&(H=oe,Za(k,oe,N[I]))})}else if(nn(C.PATTERN))if(C.PATTERN.unicode)_=!1,e.ensureOptimizations&&(`${pa}${C.PATTERN.toString()}`,void 0);else{const H=Om(C.PATTERN,e.ensureOptimizations);ae(H)&&(_=!1),q(H,K=>{Za(k,K,N[I])})}else e.ensureOptimizations&&(`${pa}${C.name}`,void 0),_=!1;return k},[])}),{emptyGroups:E,patternIdxToConfig:N,charCodeToPatternIdxToConfig:S,hasCustom:i,canBeOptimized:_}}function Fm(t,e){let n=[];const r=Um(t);n=n.concat(r.errors);const i=qm(r.valid),s=i.valid;return n=n.concat(i.errors),n=n.concat(Gm(s)),n=n.concat(Ym(s)),n=n.concat(Xm(s,e)),n=n.concat(Jm(s)),n}function Gm(t){let e=[];const n=ht(t,r=>nn(r[Kn]));return e=e.concat(zm(n)),e=e.concat(Vm(n)),e=e.concat(Km(n)),e=e.concat(Hm(n)),e=e.concat(Bm(n)),e}function Um(t){const e=ht(t,i=>!z(i,Kn)),n=M(e,i=>({message:"Token Type: ->"+i.name+"<- missing static 'PATTERN' property",type:$e.MISSING_PATTERN,tokenTypes:[i]})),r=_a(t,e);return{errors:n,valid:r}}function qm(t){const e=ht(t,i=>{const s=i[Kn];return!nn(s)&&!Xn(s)&&!z(s,"exec")&&!nt(s)}),n=M(e,i=>({message:"Token Type: ->"+i.name+"<- static 'PATTERN' can only be a RegExp, a Function matching the {CustomPatternMatcherFunc} type or an Object matching the {ICustomPattern} interface.",type:$e.INVALID_PATTERN,tokenTypes:[i]})),r=_a(t,e);return{errors:n,valid:r}}const jm=/[^\\][$]/;function zm(t){class e extends xa{constructor(){super(...arguments),this.found=!1}visitEndAnchor(s){this.found=!0}}const n=ht(t,i=>{const s=i.PATTERN;try{const a=Fa(s),o=new e;return o.visit(a),o.found}catch{return jm.test(s.source)}});return M(n,i=>({message:`Unexpected RegExp Anchor Error:
	Token Type: ->`+i.name+`<- static 'PATTERN' cannot contain end of input anchor '$'
	See chevrotain.io/docs/guide/resolving_lexer_errors.html#ANCHORS	for details.`,type:$e.EOI_ANCHOR_FOUND,tokenTypes:[i]}))}function Bm(t){const e=ht(t,r=>r.PATTERN.test(""));return M(e,r=>({message:"Token Type: ->"+r.name+"<- static 'PATTERN' must not match an empty string",type:$e.EMPTY_MATCH_PATTERN,tokenTypes:[r]}))}const Wm=/[^\\[][\^]|^\^/;function Vm(t){class e extends xa{constructor(){super(...arguments),this.found=!1}visitStartAnchor(s){this.found=!0}}const n=ht(t,i=>{const s=i.PATTERN;try{const a=Fa(s),o=new e;return o.visit(a),o.found}catch{return Wm.test(s.source)}});return M(n,i=>({message:`Unexpected RegExp Anchor Error:
	Token Type: ->`+i.name+`<- static 'PATTERN' cannot contain start of input anchor '^'
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#ANCHORS	for details.`,type:$e.SOI_ANCHOR_FOUND,tokenTypes:[i]}))}function Km(t){const e=ht(t,r=>{const i=r[Kn];return i instanceof RegExp&&(i.multiline||i.global)});return M(e,r=>({message:"Token Type: ->"+r.name+"<- static 'PATTERN' may NOT contain global('g') or multiline('m')",type:$e.UNSUPPORTED_FLAGS_FOUND,tokenTypes:[r]}))}function Hm(t){const e=[];let n=M(t,s=>Je(t,(a,o)=>(s.PATTERN.source===o.PATTERN.source&&!et(e,o)&&o.PATTERN!==tt.NA&&(e.push(o),a.push(o)),a),[]));n=rs(n);const r=ht(n,s=>s.length>1);return M(r,s=>{const a=M(s,c=>c.name);return{message:`The same RegExp pattern ->${kt(s).PATTERN}<-has been used in all of the following Token Types: ${a.join(", ")} <-`,type:$e.DUPLICATE_PATTERNS_FOUND,tokenTypes:s}})}function Ym(t){const e=ht(t,r=>{if(!z(r,"GROUP"))return!1;const i=r.GROUP;return i!==tt.SKIPPED&&i!==tt.NA&&!nt(i)});return M(e,r=>({message:"Token Type: ->"+r.name+"<- static 'GROUP' can only be Lexer.SKIPPED/Lexer.NA/A String",type:$e.INVALID_GROUP_TYPE_FOUND,tokenTypes:[r]}))}function Xm(t,e){const n=ht(t,i=>i.PUSH_MODE!==void 0&&!et(e,i.PUSH_MODE));return M(n,i=>({message:`Token Type: ->${i.name}<- static 'PUSH_MODE' value cannot refer to a Lexer Mode ->${i.PUSH_MODE}<-which does not exist`,type:$e.PUSH_MODE_DOES_NOT_EXIST,tokenTypes:[i]}))}function Jm(t){const e=[],n=Je(t,(r,i,s)=>{const a=i.PATTERN;return a===tt.NA||(nt(a)?r.push({str:a,idx:s,tokenType:i}):nn(a)&&Zm(a)&&r.push({str:a.source,idx:s,tokenType:i})),r},[]);return q(t,(r,i)=>{q(n,({str:s,idx:a,tokenType:o})=>{if(i<a&&Qm(s,r.PATTERN)){const c=`Token: ->${o.name}<- can never be matched.
...
`,type:$e.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE}),z(t,Ds)||r.push({message:"A MultiMode Lexer cannot be initialized without a <"+Ds+`> property in its definition
`,type:$e.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY}),z(t,Ds)&&z(t,Fi)&&!z(t.modes,t.defaultMode)&&r.push({message:`A MultiMode Lexer cannot be initialized with a ${Fi}: <${t.defaultMode}>which does not exist
`,type:$e.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST}),z(t,Ds)&&q(t.modes,(i,s)=>{q(i,(a,o)=>{if(tn(a))r.push({message:`A Lexer cannot be initialized using an undefined Token Type. Mode:<${s}> at index: <${o}>
`,type:$e.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED});else if(z(a,"LONGER_ALT")){const c=je(a.LONGER_ALT)?a.LONGER_ALT:[a.LONGER_ALT];q(c,l=>{!tn(l)&&!et(i,l)&&r.push({message:`A MultiMode Lexer cannot be initialized with a longer_alt <${l.name}> on token <${a.name}> outside of mode <${s}>
`,type:$e.MULTI_MODE_LEXER_LONGER_ALT_NOT_IN_CURRENT_MODE})})}})}),r}function ng(t,e,n){const r=[];let i=!1;const s=rs(yt(Pe(t.modes))),a=Ia(s,c=>c[Kn]===tt.NA),o=lf(n);return e&&q(a,c=>{const l=cf(c,o);if(l!==!1){const f={message:ag(c,l),type:l.issue,tokenType:c};r.push(f)}else z(c,"LINE_BREAKS")?c.LINE_BREAKS===!0&&(i=!0):dl(o,c.PATTERN)&&(i=!0)}),e&&!i&&r.push({message:`Warning: No LINE_BREAKS Found.
	This Lexer has been defined to track line and column information,
	But none of the Token Types can be identified as matching a line terminator.
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#LINE_BREAKS 
	for details.`,type:$e.NO_LINE_BREAKS_FLAGS}),r}function rg(t){const e={},n=jr(t);return q(n,r=>{const i=t[r];if(je(i))e[r]=[];else throw Error("non exhaustive match")}),e}function of(t){const e=t.PATTERN;if(nn(e))return!1;if(Xn(e))return!0;if(z(e,"exec"))return!0;if(nt(e))return!1;throw Error("non exhaustive match")}function ig(t){return nt(t)&&t.length===1?t.charCodeAt(0):!1}const sg={test:function(t){const e=t.length;for(let n=this.lastIndex;n<e;n++){const r=t.charCodeAt(n);if(r===10)return this.lastIndex=n+1,!0;if(r===13)return t.charCodeAt(n+1)===10?this.lastIndex=n+2:this.lastIndex=n+1,!0}return!1},lastIndex:0};function cf(t,e){if(z(t,"LINE_BREAKS"))return!1;if(nn(t.PATTERN)){try{dl(e,t.PATTERN)}catch(n){return{issue:$e.IDENTIFY_TERMINATOR,errMsg:n.message}}return!1}else{if(nt(t.PATTERN))return!1;if(of(t))return{issue:$e.CUSTOM_LINE_BREAK};throw Error("non exhaustive match")}}function ag(t,e){if(e.issue===$e.IDENTIFY_TERMINATOR)return`Warning: unable to identify line terminator usage in pattern.
...
`+i)}return this.tokenizeInternal(e,n)}tokenizeInternal(e,n){let r,i,s,a,o,c,l,u,f,g,h,E,N,_,S;const k=e,C=k.length;let I=0,H=0;const K=this.hasCustom?0:Math.floor(e.length/10),J=new Array(K),oe=[];let de=this.trackStartLines?1:void 0,fe=this.trackStartLines?1:void 0;const b=rg(this.emptyGroups),R=this.trackStartLines,m=this.config.lineTerminatorsPattern;let $=0,y=[],T=[];const A=[],O=[];Object.freeze(O);let D=!1;const x=B=>{if(A.length===1&&B.tokenType.PUSH_MODE===void 0){const ne=this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(B);oe.push({offset:B.startOffset,line:B.startLine,column:B.startColumn,length:B.image.length,message:ne})}else{A.pop();const ne=zn(A);y=this.patternIdxToConfig[ne],T=this.charCodeToPatternIdxToConfig[ne],$=y.length;const Oe=this.canModeBeOptimized[ne]&&this.config.safeMode===!1;T&&Oe?D=!0:D=!1}};function j(B){A.push(B),T=this.charCodeToPatternIdxToConfig[B],y=this.patternIdxToConfig[B],$=y.length,$=y.length;const ne=this.canModeBeOptimized[B]&&this.config.safeMode===!1;T&&ne?D=!0:D=!1}j.call(this,n);let G;const ie=this.config.recoveryEnabled;for(;I<C;){c=null,f=-1;const B=k.charCodeAt(I);let ne;if(D){const ve=fn(B),he=T[ve];ne=he!==void 0?he:O}else ne=y;const Oe=ne.length;for(r=0;r<Oe;r++){G=ne[r];const ve=G.pattern;l=null;const he=G.short;if(he!==!1?B===he&&(f=1,c=ve):G.isCustom===!0?(S=ve.exec(k,I,J,b),S!==null?(c=S[0],f=c.length,S.payload!==void 0&&(l=S.payload)):c=null):(ve.lastIndex=I,f=this.matchLength(ve,e,I)),f!==-1){if(o=G.longerAlt,o!==void 0){c=e.substring(I,I+f);const _e=o.length;for(s=0;s<_e;s++){const xe=y[o[s]],Ne=xe.pattern;if(u=null,xe.isCustom===!0?(S=Ne.exec(k,I,J,b),S!==null?(a=S[0],S.payload!==void 0&&(u=S.payload)):a=null):(Ne.lastIndex=I,a=this.match(Ne,e,I)),a&&a.length>c.length){c=a,f=a.length,l=u,G=xe;break}}}break}}if(f!==-1){if(g=G.group,g!==void 0&&(c=c!==null?c:e.substring(I,I+f),h=G.tokenTypeIdx,E=this.createTokenInstance(c,I,h,G.tokenType,de,fe,f),this.handlePayload(E,l),g===!1?H=this.addToken(J,H,E):b[g].push(E)),R===!0&&G.canLineTerminator===!0){let ve=0,he,_e;m.lastIndex=0;do c=c!==null?c:e.substring(I,I+f),he=m.test(c),he===!0&&(_e=m.lastIndex-1,ve++);while(he===!0);ve!==0?(de=de+ve,fe=f-_e,this.updateTokenEndLineColumnLocation(E,g,_e,ve,de,fe,f)):fe=this.computeNewColumn(fe,f)}else fe=this.computeNewColumn(fe,f);I=I+f,this.handleModes(G,x,j,E)}else{const ve=I,he=de,_e=fe;let xe=ie===!1;for(;xe===!1&&I<C;)for(I++,i=0;i<$;i++){const Ne=y[i],Z=Ne.pattern,at=Ne.short;if(at!==!1?k.charCodeAt(I)===at&&(xe=!0):Ne.isCustom===!0?xe=Z.exec(k,I,J,b)!==null:(Z.lastIndex=I,xe=Z.exec(e)!==null),xe===!0)break}if(N=I-ve,fe=this.computeNewColumn(fe,N),_=this.config.errorMessageProvider.buildUnexpectedCharactersMessage(k,ve,N,he,_e,zn(A)),oe.push({offset:ve,line:he,column:_e,length:N,message:_}),ie===!1)break}}return this.hasCustom||(J.length=H),{tokens:J,groups:b,errors:oe}}handleModes(e,n,r,i){if(e.pop===!0){const s=e.push;n(i),s!==void 0&&r.call(this,s)}else e.push!==void 0&&r.call(this,e.push)}updateTokenEndLineColumnLocation(e,n,r,i,s,a,o){let c,l;n!==void 0&&(c=r===o-1,l=c?-1:0,i===1&&c===!0||(e.endLine=s+l,e.endColumn=a-1+-l))}computeNewColumn(e,n){return e+n}createOffsetOnlyToken(e,n,r,i){return{image:e,startOffset:n,tokenTypeIdx:r,tokenType:i}}createStartOnlyToken(e,n,r,i,s,a){return{image:e,startOffset:n,startLine:s,startColumn:a,tokenTypeIdx:r,tokenType:i}}createFullToken(e,n,r,i,s,a,o){return{image:e,startOffset:n,endOffset:n+o-1,startLine:s,endLine:s,startColumn:a,endColumn:a+o-1,tokenTypeIdx:r,tokenType:i}}addTokenUsingPush(e,n,r){return e.push(r),n}addTokenUsingMemberAccess(e,n,r){return e[n]=r,n++,n}handlePayloadNoCustom(e,n){}handlePayloadWithCustom(e,n){n!==null&&(e.payload=n)}match(e,n,r){return e.test(n)===!0?n.substring(r,e.lastIndex):null}matchLength(e,n,r){return e.test(n)===!0?e.lastIndex-r:-1}}tt.SKIPPED="This marks a skipped Token pattern, this means each token identified by it will be consumed and then thrown into oblivion, this can be used to for example to completely ignore whitespace.";tt.NA=/NOT_APPLICABLE/;function Sr(t){return hf(t)?t.LABEL:t.name}function hf(t){return nt(t.LABEL)&&t.LABEL!==""}const mg="parent",Yl="categories",Xl="label",Jl="group",Ql="push_mode",Zl="pop_mode",eu="longer_alt",tu="line_breaks",nu="start_chars_hint";function pf(t){return gg(t)}function gg(t){const e=t.pattern,n={};if(n.name=t.name,tn(e)||(n.PATTERN=e),z(t,mg))throw`The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;return z(t,Yl)&&(n.CATEGORIES=t[Yl]),ls([n]),z(t,Xl)&&(n.LABEL=t[Xl]),z(t,Jl)&&(n.GROUP=t[Jl]),z(t,Zl)&&(n.POP_MODE=t[Zl]),z(t,Ql)&&(n.PUSH_MODE=t[Ql]),z(t,eu)&&(n.LONGER_ALT=t[eu]),z(t,tu)&&(n.LINE_BREAKS=t[tu]),z(t,nu)&&(n.START_CHARS_HINT=t[nu]),n}const hn=pf({name:"EOF",pattern:tt.NA});ls([hn]);function fl(t,e,n,r,i,s,a,o){return{image:e,startOffset:n,endOffset:r,startLine:i,endLine:s,startColumn:a,endColumn:o,tokenTypeIdx:t.tokenTypeIdx,tokenType:t}}function mf(t,e){return cs(t,e)}const Ar={buildMismatchTokenMessage({expected:t,actual:e,previous:n,ruleName:r}){return`Expecting ${hf(t)?`--> ${Sr(t)} <--`:`token of type --> ${t.name} <--`} but found --> '${e.image}' <--`},buildNotAllInputParsedMessage({firstRedundant:t,ruleName:e}){return"Redundant input, expecting EOF but found: "+t.image},buildNoViableAltMessage({expectedPathsPerAlt:t,actual:e,previous:n,customUserDescription:r,ruleName:i}){const s="Expecting: ",o=`
but found: '`+kt(e).image+"'";if(r)return s+r+o;{const c=Je(t,(g,h)=>g.concat(h),[]),l=M(c,g=>`[${M(g,h=>Sr(h)).join(", ")}]`),f=`one of these possible Token sequences:
${M(l,(g,h)=>`  ${h+1}. ${g}`).join(`
...
but found: '`+kt(e).image+"'";if(n)return i+n+a;{const c=`expecting at least one iteration which starts with one of these possible Token sequences::
  <${M(t,l=>`[${M(l,u=>Sr(u)).join(",")}]`).join(" ,")}>`;return i+c+a}}};Object.freeze(Ar);const yg={buildRuleNotFoundError(t,e){return"Invalid grammar, reference to a rule which is not defined: ->"+e.nonTerminalName+`<-
inside top level rule: ->`+t.name+"<-"}},qn={buildDuplicateFoundError(t,e){function n(u){return u instanceof ue?u.terminalType.name:u instanceof Qe?u.nonTerminalName:""}const r=t.name,i=kt(e),s=i.idx,a=Pt(i),o=n(i),c=s>0;let l=`->${a}${c?s:""}<- ${o?`with argument: ->${o}<-`:""}
...
${n}`),this.inline?`{${i}}`:i}}function ov(t,e,n){var r;if(t==="linkplain"||t==="linkcode"||t==="link"){const i=e.indexOf(" ");let s=e;if(i>0){const o=Vc(e,i);s=e.substring(o),e=e.substring(0,i)}return(t==="linkcode"||t==="link"&&n.link==="code")&&(s=`\`${s}\``),((r=n.renderLink)==null?void 0:r.call(n,e,s))??cv(e,s)}}function cv(t,e){try{return Ct.parse(t,!0),`[${e}](${t})`}catch{return t}}class Kc{constructor(e,n){this.inlines=e,this.range=n}toString(){let e="";for(let n=0;n<this.inlines.length;n++){const r=this.inlines[n],i=this.inlines[n+1];e+=r.toString(),i&&i.range.start.line>r.range.start.line&&(e+=`
