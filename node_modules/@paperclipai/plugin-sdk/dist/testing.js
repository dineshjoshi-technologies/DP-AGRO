        ...
        issues: {
            ...
            async listComments(issueId, companyId) {
                ...
                if (!isInCompany(issues.get(issueId), companyId))
                    return [];
                return (issueComments.get(issueId) ?? []).map((comment) => comment.deletedAt ? { ...comment, body: "", presentation: null, metadata: null } : comment);
            },
            ...
            async requestCheckboxConfirmation(issueId, interaction, companyId, options) {
                return this.createInteraction(issueId, { ...interaction, kind: "request_checkbox_confirmation" }, companyId, options);
            },
            documents: {
