 ...
 */
export declare class InvocationScopeDeniedError extends Error {
    readonly name = "InvocationScopeDeniedError";
    readonly code: -32005;
 ...
 */
type HostHandler<M extends WorkerToHostMethodName> = (params: WorkerToHostMethods[M][0], context?: WorkerHostCallContext) => Promise<WorkerToHostMethods[M][1]>;
/**
