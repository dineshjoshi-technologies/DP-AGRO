...
describe("createRuntimeProgressReporter", () => {
    ...
    it("always emits the terminal 100% line via report reaching the total", async () => {
        ...
        expect(lines[lines.length - 1]).toBe("[paperclip] Restoring workspace from sandbox: 100% (100.0/100.0 MB)\n");
    });
    it("complete() emits the terminal 100% line even when intermediate emits were throttled", async () => {
        ...
        expect(lines[lines.length - 1]).toBe("[paperclip] Syncing workspace to sandbox: 100% (100.0/100.0 MB)\n");
    });
...
//# sourceMappingURL=runtime-progress.test.js.map