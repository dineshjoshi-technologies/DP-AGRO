...
describe("sandbox adapter execution targets", () => {
    ...
    it("applies the remote sandbox fallback when adapter timeoutSec is unset", () => {
        ...
        expect(resolveAdapterExecutionTargetTimeoutSec(sandboxTarget, 0)).toBe(DEFAULT_REMOTE_SANDBOX_ADAPTER_TIMEOUT_SEC);
    ...
    it("uses the caller timeout override when installing a missing sandbox command", async () => {
        ...
        await ensureAdapterExecutionTargetCommandResolvable("opencode", target, "/local/workspace", {}, { installCommand: "npm install -g opencode", timeoutSec: 1800 });
    ...
    it("uses the effective adapter timeout when starting the sandbox callback bridge", async () => {
        ...
        const runner = {
            execute: vi.fn(async (input) => delegateRunner.execute(input)),
        };
        const apiServer = createServer((req, res) => {
            res.writeHead(200, { "content-type": "application/json" });
            res.end(JSON.stringify({ ok: true }));
...
//# sourceMappingURL=execution-target-sandbox.test.js.map